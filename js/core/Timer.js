...
export class Timer {
    ...
    startCountdown(timerName, initialValue, callback, displayElement = null) {
        ...
        const updateCountdown = () => {
            ...
            // Update display
            if (displayElement) {
                if (timerName.includes('performance') || timerName.includes('editing')) {
                    // Format as MM:SS for longer timers
                    this.uiManager.updateCountdown(displayElement, this.uiManager.formatTime(currentValue));
                } else {
    ...
    startPhaseCountdown(countdownElement, callback) {
        ...
        if (countdownElement === 'phaseCountdown') {
            ...
            this.uiManager.showEditingPhaseCountdown(this.gameState.timers.phaseCountdown);
        }
