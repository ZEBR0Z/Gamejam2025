...
export class PhaseManager {
    ...
    transitionTo(phaseName, ...args) {
        ...
        if (!this.canTransitionTo(phaseName)) {
            console.error(`Invalid transition from '${this.currentPhaseName}' to '${phaseName}'`);
            return false;
        }
        ...
        console.log(`Phase transition: ${this.currentPhaseName || 'none'} -> ${phaseName}`);
    ...
    forceTransitionTo(phaseName, ...args) {
        ...
        console.log(`Force transition: ${this.currentPhaseName || 'none'} -> ${phaseName}`);
