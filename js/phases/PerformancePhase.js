...
export class PerformancePhase {
    ...
    start(onComplete) {
        ...
        this.gameState.timers.performanceTimeLeft = this.gameState.config.performanceTime;
    ...
    setupUI() {
        ...
        this.uiManager.updateTransportControls('performance', false, 0, this.gameState.config.segmentLength);
    }

    setupEventHandlers() {
        // Register input handlers
        this.inputController.registerHandler('keyPress', 'performance', (soundIndex) => {
            this.handleKeyPress(soundIndex);
        });

        this.inputController.registerHandler('timelineRightClick', 'performance', (mouseX, mouseY) => {
    ...
    startAnimation() {
        const animate = () => {
            if (this.gameState.getState() === 'performance' && this.gameState.playback.isPlaying) {
    ...
    play() {
        ...
        this.uiManager.updateTransportControls('performance', true, this.gameState.playback.currentTime, this.gameState.config.segmentLength);
    }
    ...
    pause() {
        ...
        this.uiManager.updateTransportControls('performance', false, this.gameState.playback.currentTime, this.gameState.config.segmentLength);
    }
    ...
    restart() {
        ...
        this.uiManager.updateTransportControls('performance', this.gameState.playback.isPlaying, 0, this.gameState.config.segmentLength);
    }
    ...
    seekTo(time) {
        ...
        this.uiManager.updateTransportControls('performance', this.gameState.playback.isPlaying, time, this.gameState.config.segmentLength);
    }
